            ...
            <div className="container-fluid">
                <div className="row justify-content-evenly">
                    <div className="col-12 col-lg-3">
                        <GroupSidenav userDisplayname={props.userDisplayname} userInfo={props.userInfo} allusers={props.allusers} myGroups={props.myGroups} allgroups={props.allgroups}/>
                    </div>
                    <div className="col-12 col-lg-6 pb-5 p-3">
                        ...
                        <h5><strong>Your Feed</strong></h5>
                            <CreateGroupPost userDisplayname={props.userDisplayname} userInfo={props.userInfo} allusers={props.allusers} myGroups={props.myGroups} allgroups={props.allgroups} />
                            <GroupPostCard userDisplayname={props.userDisplayname} userInfo={props.userInfo} allusers={props.allusers} myGroups={props.myGroups} allgroups={props.allgroups} />
                        </div>
                    </div>
