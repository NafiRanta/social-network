                ...
                <div className="row justify-content-evenly">
                    ...
                    <div className="col col-lg-9 pb-5 p-3">
                        <div className="d-flex flex-column justify-content-center w-100 " id="d-flex-postcontainer-allGroups">
                            ...
                            <GroupProfileCard userDisplayname={props.userDisplayname} username={props.username} userInfo={props.userInfo} allusers={props.allusers} myGroups={props.myGroups} allgroups={props.allgroups}/>
                        </div>
                    </div>
